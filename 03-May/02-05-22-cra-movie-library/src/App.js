  ...
  return (
    <Router>
      <div className="all">
        ...
        <Alert visibility={alert} message={message}/>
        <Routes>
          <Route path="/edit-movie/:id" element={<EditSection alert={setAlert} message={setMessage}/>}/>
          <Route path="/add-movie" element={<AddMovie alert={setAlert} message={setMessage}/>} />
          <Route path="/" element={<Home alert={setAlert} message={setMessage}/>} />
        </Routes>
      </div>
    </Router>
  );
